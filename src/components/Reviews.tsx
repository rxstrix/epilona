...
const reviews: Review[] = [
  {
    name: 'Анна',
    text: 'Электроэпиляция лица и классическое бикини. Всё деликатно, спокойно и без ощущения «эксперимента на себе».',
    rating: 5,
    source: 'instagram',
  },
  {
    name: 'Мария',
    text: 'Голени и подмышки — спустя несколько сеансов почти ничего не отрастает. Нравится, что всегда напоминают, как подготовиться.',
    rating: 5,
    source: 'instagram',
  },
  {
    name: 'Елена',
    text: 'Долго выбирала между разными методами. Здесь всё объяснили по-человечески и подобрали комфортный график.',
    rating: 5,
    source: 'telegram',
  },
  {
    name: 'Дарья',
    text: 'Страх перед «иголочками» прошёл на первом сеансе. Можно включить любимую музыку и просто расслабиться.',
    rating: 5,
    source: 'telegram',
  },
  {
    name: 'Ольга',
    text: 'Интимная зона и подмышки — с анестезией всё переносится спокойно. Волосы становятся тоньше и реже.',
    rating: 5,
    source: 'instagram',
  },
  {
    name: 'Кристина',
    text: 'Запись без очередей, аккуратный кабинет и стерильные инструменты. Чувствую себя на персональной процедуре.',
    rating: 5,
    source: 'tiktok',
  },
  {
    name: 'Светлана',
    text: 'Брала курс на ноги полностью. Спустя несколько месяцев кожа гладкая, остались только единичные пушковые волоски.',
    rating: 5,
    source: 'instagram',
  },
]
...
export function Reviews() {
  return (
    <section id="reviews" className="py-24 relative overflow-hidden bg-dark">
      {/* Однородный фон в той же тёмной палитре, что и услуги и цены */}
